...
<body>	
	<?php $userlogin = $_SESSION['login_user'];?>
	<h3>Chọn phương thức thanh toán</h3>
	<form  name="NLpayBank" action="<?php echo BASE_URL.'thanhtoan'?>" method="post">	
		<table style="clear:both;width:500px;padding-left:46px;"> 
			...
			<tr><td>Số tiền thanh toán: </td>
				<td>
					 <input type="text" style="width:270px" id="total_amount" name="total_amount" class="field-check " value="<?=$ttdh['tongtien'];?>" readonly = 'readonly'>
				</td>
			</tr>
			<tr><td>Họ Tên: </td>
				<td>
					 <input type="text" style="width:270px" id="fullname" name="buyer_fullname" class="field-check " value="<?=$ttdh['tennguoinhan'];?>">
				</td>
			</tr>
			<tr><td>Email: </td>
				<td>
					 <input type="text" style="width:270px" id="fullname" name="buyer_email" class="field-check " value="<?=$userlogin["email"];?>">
				</td>
			</tr>
			<tr><td>Số Điện thoại: </td>
				<td>
					 <input type="text" style="width:270px" id="fullname" name="buyer_mobile" class="field-check " value="<?=$ttdh['dtnguoinhan'];?>">
				</td>
			</tr>				
		</table>	
